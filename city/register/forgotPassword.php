<?php
 ...
 function send_password_reset($string,$get_email){
    ...
    $email_template="
      ...
      <br><a href='http://localhost/Parking_site/city/register/updatePassword.php'>Resetare</a>
    ";
 ...
 if(isset($_POST['button'])){
  ...
  $ok=1;
  $stmt=$connection->prepare("SELECT * FROM city_account WHERE email=? and ok=? limit 1");
    $stmt->bind_param("si",$email,$ok);
    $stmt->execute();
